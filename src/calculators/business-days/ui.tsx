...
export default function BusinessDaysUi() {
  ...
  return <div className="mx-auto w-full max-w-6xl flex-1 px-5 py-10 sm:px-8 sm:py-14">
    <header className="max-w-3xl"><Link href="/categories/date" className="mb-3 inline-block text-sm font-semibold text-primary hover:underline">날짜</Link><h1 className="text-3xl font-bold tracking-[-0.03em] sm:text-4xl">영업일 계산기</h1><p className="mt-3 text-base leading-7 text-muted">주말과 대한민국 공휴일·대체공휴일을 제외한 영업일 수와 도착 날짜를 계산합니다.</p><p className="mt-2 text-sm font-medium text-primary">공휴일 지원 범위 {HOLIDAY_DATA_YEARS}</p></header>
